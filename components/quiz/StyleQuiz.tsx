...
export default function StyleQuiz() {
  ...
  return (
    <section id="quiz" className="py-20 bg-white flex flex-col items-center px-6 overflow-hidden border-t border-black/5 relative">
      ...
      {currentStep < 3 && (
        <div className="hidden lg:flex absolute bottom-[120px] right-[-65px] w-[300px] lg:w-[400px] h-[300px] lg:h-[400px] justify-center items-center pointer-events-none z-0 drop-shadow-2xl">
          <QuizModel />
        </div>
      )}
