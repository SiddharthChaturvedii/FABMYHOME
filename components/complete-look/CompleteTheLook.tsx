  ...
  return (
    <section className="pt-0 pb-48 bg-white relative overflow-visible">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start">
        ...
        <div className="hidden lg:flex absolute top-[4.5%] right-[6%] w-1/3 h-full justify-center items-start pointer-events-none z-0 drop-shadow-2xl">
          <img 
            src="/pillar.png" 
            alt="Decorative Pillar" 
            className="object-contain h-full max-h-[900px] transform -translate-y-2"
          />
        </div>
