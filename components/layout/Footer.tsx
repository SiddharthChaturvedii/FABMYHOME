...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-sage)] text-black pt-20 md:pt-32 pb-12 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-5 gap-16 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-2 flex flex-col items-start md:items-center lg:items-start text-left md:text-center lg:text-left">
            ...
            <p className="font-sans text-black text-lg md:text-xl leading-relaxed font-light italic max-w-sm md:max-w-2xl lg:max-w-sm">
              India&apos;s first AI-assisted interior styling platform. <br className="hidden md:block lg:hidden" />
              <span className="text-black">We believe every room has a story to tell.</span>
            </p>
          </div>
            ...
            <div className="flex flex-col text-left min-w-[140px] pt-12 md:pt-0 border-t border-white/5 md:border-t-0">
              ...
              <ul className="space-y-3 md:space-y-1.5 mt-2">
                {footerLinks.categories.map((link) => (
                  <li key={link.label}>
                    <Link href={link.href} className="font-sans text-[13px] font-medium text-black hover:text-[var(--color-terracotta)] transition-all duration-300 tracking-wide block">
                      {link.label}
                    </Link>
                  </li>
                ))}
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col lg:flex-row justify-between items-center gap-6 md:gap-8 text-center lg:text-left">
          <div className="flex gap-8 md:gap-10 justify-center lg:justify-start">
            <Link href="#" className="font-sans text-[11px] uppercase tracking-[0.2em] font-bold text-black hover:text-[var(--color-terracotta)] transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="font-sans text-[11px] uppercase tracking-[0.2em] font-bold text-black hover:text-[var(--color-terracotta)] transition-colors">
              Terms of Service
          ...
          <p className="font-sans text-[11px] uppercase tracking-[0.2em] font-bold text-black/70">
