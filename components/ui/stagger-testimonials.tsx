...
const testimonials = [
  {
    tempId: 0,
    testimonial: "FabMyHome completely transformed my living room in minutes. Truly magical!",
    by: "Priya S.",
    imgSrc: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80"
  },
  {
    tempId: 1,
    testimonial: "The AI-matching is scary accurate. It found the perfect curtains for my bedroom.",
    by: "Rahul M.",
    imgSrc: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80"
  },
  {
    tempId: 2,
    testimonial: "Minimal effort, maximum aesthetic. This is the future of interior design.",
    by: "Ananya K.",
    imgSrc: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80"
  },
  {
    tempId: 3,
    testimonial: "I saved weeks of hunting for the right furniture. Exceptional experience.",
    by: "Vikram D.",
    imgSrc: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80"
  },
  {
    tempId: 4,
    testimonial: "Finally, a tool that understands my style better than I do!",
    by: "Sarah J.",
    imgSrc: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=150&q=80"
  },
  {
    tempId: 5,
    testimonial: "The 30-second promise is real. I had a full room concept in under a minute.",
    by: "Deepa R.",
...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ 
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCenter 
          ...
          : "z-0 bg-white text-black border-black/10 hover:border-black/50"
      )}
      style={{
        width: cardSize,
        height: cardSize,
    ...
    >
      <span
        className={cn("absolute block origin-top-right rotate-45", isCenter ? "bg-white/20" : "bg-black/10")}
        style={{
          right: -2,
          top: 48,
          width: SQRT_5000,
