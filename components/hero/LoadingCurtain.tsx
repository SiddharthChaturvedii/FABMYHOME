    ...
    <AnimatePresence>
      {visible && (
        <motion.div 
          ...
          className="fixed inset-0 z-[9999] bg-[#124444] flex flex-col items-center justify-center pointer-events-none border-b border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
        >
